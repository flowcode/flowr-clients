...
namespace Flower\ModelBundle\Tests\Controller\Clients;

use Symfony\Bundle\FrameworkBundle\Test\WebTestCase;

class CallEventStatusControllerTest extends WebTestCase
{
    public function testCreate()
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/clients_calleventstatus/');
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'calleventstatus[name]' => 'Lorem ipsum dolor sit amet',
            'calleventstatus[finished]' => true,
                    ));
        $client->submit($form);
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/clients_calleventstatus/new');
